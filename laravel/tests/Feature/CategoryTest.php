...
class CategoryTest extends TestCase
{
     ...
     * Precondition: A category with ID 1 should exist
     * Test Steps:
    ...
    {
        $response = $this->patch('/api/categories/1', ["name" => "test_category_updated"]); // Send Patch request to category with ID=2
